...
Revise an existing architecture plan based on changes provided by the orchestrator.
...
- Structural changes → check GitHub MCP for affected files

Only re-check AWS and GitHub for the parts affected by the changes.
