---
name: ma-gitlab-validate-requirement
description: "Check existing AWS and GitLab state, then produce an architecture plan from the requirements provided by the orchestrator."
---
